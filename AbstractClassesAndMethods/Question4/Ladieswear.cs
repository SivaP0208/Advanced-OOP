...
namespace Question4
{
    ...
    {
        private DressType _dressType=DressType.Ladieswear;
        ...
        public Ladieswear(string dressName,double totalPrice)
        {
            DressName=dressName;
        ...
        {
            _price=TotalPrice-TotalPrice*20/100.0;
            return _price;
        }
        public override void DisplayBill()
        {
            Console.WriteLine($"Price Of the Dress with 20% Discount : {CalculateDiscount()}");
        }
    }
}